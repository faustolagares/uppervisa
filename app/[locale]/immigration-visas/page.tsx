      ...
      <div className="bg-gray-900 text-white py-16 md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Expert guidance for all visa types, including immigrant visas, non-immigrant visas, permanent residency, and
            relocation services.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-[1350px] mx-auto px-4">
          ...
          <div className="mb-16">
            ...
            <p className="text-gray-600">
              Whether you're seeking permanent residency, a temporary visa, or assistance with relocation and
              settlement, our experienced team will develop a personalized strategy to maximize your chances of success.
            </p>
          </div>
